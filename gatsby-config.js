...
module.exports = {
  siteMetadata: {
    ...
    title: "AYDev",
    description:
      "Hi, I'm Adam Young, a Software Engineer based in County Durham, currently working at Checkout.com. Here, you'll find articles about software development, my interests, and the projects I've currently got on the go.",
  },
  plugins: [
    {
            ...
            serialize: ({ query: { site, allContentfulPageBlogPost } }) => {
              return allContentfulPageBlogPost.nodes.map((node) => {
                return {
                  ...
                  custom_elements: [
                    { "content:encoded": marked(node.copy.copy) },
                  ],
                };
              });
            },
