      ...
      const a = e => document.querySelector(e),
        ...
        u = (e, t = 0) => {
          const i = c(e),
            ...
            s = o ? { r: parseInt(o[1], 16), g: parseInt(o[2], 16), b: parseInt(o[3], 16) } : null;
      ...
      (r.VantaBase = class {
        ...
        windowMouseMoveWrapper(e) {
          ...
          o >= 0 &&
            ...
            o <= i.width &&
            s <= i.height &&
            ((this.mouseX = o), (this.mouseY = s), this.options.mouseEase || this.triggerMouseMove(o, s));
        }
            ...
            (t.setup = function() {
              ...
              (t.draw = function() {
                t.translate(-r, -r),
                  ...
                  (function() {
                    t.strokeWeight(1), t.stroke(Object(s.b)(e.options.color, 0.05));
                    for (let e = 0; e < f.length; e++)
                      n.Vector.dist(f[e].prev, f[e].pos) < 10 && t.line(f[e].prev.x, f[e].prev.y, f[e].pos.x, f[e].pos.y);
                  })(),
                  (m += 0.002);
              });
          });
    ...
    3: function(e, t, i) {
      ...
      class r extends o.b {
        ...
        initP5(e) {
          ...
          i.parent(t.el), t.applyCanvasStyles(e.canvas), (t.p5renderer = i), (t.p5canvas = e.canvas), (t.p5 = e);
        }
        restart() {
