...
import {
  ...
  ThreePanelSubtitle,
  ThreePanelTitle,
} from "~components/sections/three-panel";
import {
  TwoPanel,
  TwoPanelBlock,
  TwoPanelBody,
    ...
    <TwoPanel disableMotion>
      <TwoPanelBlock>
        <TwoPanelHeading>
          ...
          <TwoPanelSubtitle>
            My history, background, interests and everything else you need to
            know.
          </TwoPanelSubtitle>
        </TwoPanelHeading>
        <TwoPanelBody>
      ...
      <ThreePanel>
        <ThreePanelBlock>
          ...
          <Stack>
            ...
            <ThreePanelSubtitle>
              ...
              <Link href="https://checkout.com">Checkout.com</Link>, and on some{" "}
        ...
        <ThreePanelBlock>
          ...
          <Stack>
            ...
            <ThreePanelSubtitle>
              Check out my{" "}
              <Link href="https://unsplash.com/@adammyoung">Unsplash</Link>{" "}
              page.
            </ThreePanelSubtitle>
          </Stack>
        </ThreePanelBlock>
    ...
    <TwoPanel id="about-me">
      ...
      <TwoPanelBlock>
        <TwoPanelHeading>
          ...
          <TwoPanelSubtitle>
            I was born in 1997, in the North East of England.
          </TwoPanelSubtitle>
        </TwoPanelHeading>
        <Stack spacing="4">
          <TwoPanelBody>
            <Text>
              I attended Teesside University, and graduated in 2018 with a
              Bachelors in Computer Science. During my final year of university
              is when I first started with React, and I've been obsessed with
              web technologies ever since.
            </Text>
          </TwoPanelBody>
          <TwoPanelBody>
            <Text>
              From there, I moved to Birmingham, and started my software
              development career. I worked at a local software development house
              as a full stack developer for around 2 years, working with mapping
              libraries and design systems before moving into a fully front-end
              role at Curve.
            </Text>
          </TwoPanelBody>
          <TwoPanelBody>
            <Text>
              After working at Curve for close to 8 months, I decided to follow
              up an opportunity to work at Checkout.com, where I'll be working
              within the website, and developer experience team.
            </Text>
          </TwoPanelBody>
        </Stack>
      </TwoPanelBlock>
    ...
    <TwoPanel>
      ...
      <TwoPanelBlock>
        <TwoPanelHeading>
          ...
          <TwoPanelSubtitle>
            I've got a uses page listing everything I use day-to-day at the link
            below.
          </TwoPanelSubtitle>
        </TwoPanelHeading>
        <TwoPanelBody>
