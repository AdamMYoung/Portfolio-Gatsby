      ...
      <TwoPanelBlock>
        <Stack>
          ...
          <TwoPanelBody as={Stack}>
            ...
            <Text pl="4">
              A front-end software engineer, passionate about creating engaging
              web experiences in React, Gatsby and Next.js. Currently working at{" "}
              <Link href="https://checkout.com">Checkout.com</Link>.
            </Text>
          </TwoPanelBody>
        </Stack>
        <Stack spacing="4">
